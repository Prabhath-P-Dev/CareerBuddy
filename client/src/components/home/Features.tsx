...
export default function Features(){
    ...
    return (
        <>
            <div className="flex flex-col md:flex-row items-center justify-center bg-gradient-to-b from-gray-100 to-blue-300">
                    ...
                    <div className={"flex items-center justify-center gap-6 max-w-md group cursor-pointer"}>
                        <div className={`p-6 group-hover:bg-violet-100 border border-transparent group-hover:border-violet-300  flex gap-4 rounded-xl transition-colors ${!isHover ? 'border-violet-300 bg-violet-100' : ''}`}>
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Personalized Career Roadmap</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Get a clear, step-by-step learning path based on your skills,interests,and career goals.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-green-100 border border-transparent group-hover:border-green-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Skills and learning Resources</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Discover the skills you need to develop,along with relevant resouces to help you to learn.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Project Recommendations</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Build practical projects that match your skill level and help you gain real-world experience.</p>
                            </div>
                        </div>
                    </div>
                </div>
